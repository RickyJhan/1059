...
function widgets_init() {
  register_sidebar([
    ...
    'id'            => 'sidebar-primary',
    'before_widget' => '<div class="widget col-sm-6 col-lg-12 %1$s %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h4>',
    'after_title'   => '</h4>'
  ]);
  ...
  register_sidebar([
    'name'          => __('Footer', 'cyon'),
    'id'            => 'sidebar-footer',
    'before_widget' => '<div class="widget col-sm-6 col-lg-3 %1$s %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h4>',
    'after_title'   => '</h4>'
  ]);
...
function create_post_types() {
  ...
  register_taxonomy(
    ...
    'team',
    array(
      'labels' => array( 'name' => __( 'Team Types', 'sage' ), 'singular_name' => __( 'Team Type', 'sage' ) ),
  ...
  register_taxonomy(
    ...
    'portfolio',
    array(
      'labels' => array( 'name' => __( 'Portfoio Types', 'sage' ), 'singular_name' => __( 'Portfoio Type', 'sage' ) ),
